...
import { useGoogleReady } from '@/components/providers/GoogleOAuthProvider'
...
// ─── Google Button (works with or without OAuth configured) ───
function GoogleSignInButton({
  ...
  // Fallback: styled button when Google OAuth is not configured
  return (
    <button
      type="button"
      onClick={onError}
      className="flex h-12 w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-4 text-sm font-medium text-gray-700 transition-all hover:bg-gray-50 active:bg-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
    >
    ...
    <Card className="shadow-lg border-emerald-200/50 dark:border-emerald-800/30">
      ...
      <CardContent>
        ...
        <GoogleSignInButton
          ...
          onError={() => setServerError('Google sign-in is not configured yet. Add your NEXT_PUBLIC_GOOGLE_CLIENT_ID to .env')}
        />
      </CardContent>
